...
module.exports = (app) => {
    ...
    app.get(
        ...
        [verifyJWT, (req, res, next) => verifyGroup(req, res, next, ["ENFERMAGEM", "MEDICOS", "ROOT"])],
        (req, res) => {
    ...
    app.post(
        "/medical-prescription",
        [validate(createValidation), verifyJWT, (req, res, next) => verifyGroup(req, res, next, ["MEDICOS"])],
        (req, res) => {
    ...
    app.patch(
        "/medical-prescription",
        [validate(updateValidation), verifyJWT, (req, res, next) => verifyGroup(req, res, next, ["MEDICOS"])],
        (req, res) => {
    ...
    app.patch(
        ...
        [validate(updateRealizedValidation), verifyJWT, (req, res, next) => verifyGroup(req, res, next, ["ENFERMAGEM"])],
        (req, res) => {
            medicalPrescriptionController.setRealized(req, res);
        }
    );
    app.patch(
        "/medical-prescription/:id/set-canceled",
        [validate(cancelValidation), verifyJWT, (req, res, next) => verifyGroup(req, res, next, ["MEDICOS"])],
        (req, res) => {
            medicalPrescriptionController.setCanceled(req, res);
        }
    );
};
